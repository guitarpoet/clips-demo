{extends file="../bootstrap-layout.tpl"}
	{block name="toolbar"}
		{button class="btn btn-default" role="datatable-action" type="ajax" for="user" uri="/user/delete"}
			{lang}ajax delete with uri{/lang}
		{/button}
		{button class="btn btn-primary" role="datatable-action" type="ajax" for="user" href="/~andy/clips-demo/index.php/user/delete"}
			{lang}ajax delete with href{/lang}
		{/button}
		{action class="btn btn-default" role="datatable-action" for="user" href="/~andy/clips-demo/index.php/user/delete"}action delete{/action}
